...
public class QueriesCardView extends TrendView {
    private LinearLayout mCardView;
    private final int TOP_MAX = 5;

    public QueriesCardView(@NonNull Context context) {
        super(context);
    }
    ...
    protected void notifyDataChanged(List<Object> data) {
        ...
        for (int i = 0; i < data.size(); i++) {
            ...
            itemView = LayoutInflater.from(mContext).inflate(R.layout.layout_rising_item,
                    mCardView, false);
    ...
    protected String getTitle() {
        return MessageFormat.format("Related rising queries in {0}", mCountryName);
    }

    @Override
    protected String getRequestUrl() {
        return Urls.QUERIES_RISING_API;
    }
}
